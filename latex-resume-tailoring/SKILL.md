...
### 3. Patch the Existing LaTeX

Edit `resume.tex` directly. Preserve:
...
- Do not replace the user's template, regenerate the resume from scratch, or normalize style across the file unless asked.
